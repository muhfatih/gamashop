...
const Checkout = () => {
  ...
  const { tagihan, setTagihan } = useAuth();

  useEffect(() => {
    setTagihan(CourierCost + TotalItemPrice);
  }, [CourierCost, TotalItemPrice]);
            ...
            <div className="flex justify-between mb-4" key={i}>
              <div className="flex pt-1">
                <div
                  ...
                  style={{
                    background:
                      selectedCourier === item.courierID
              ...
              >
                {currencyFormatter.format(item.price).split(".")[0]}
              </h3>
            </div>
          ))}
          {/* Total harga */}
